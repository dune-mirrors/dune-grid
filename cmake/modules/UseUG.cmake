...
function(add_dune_ug_flags)
  if(UG_FOUND)
    cmake_parse_arguments(ADD_UG "SOURCE_ONLY;OBJECT;TARGET_IS_LIBRARY" "" "" ${ARGN})
    if(ADD_UG_TARGET_IS_LIBRARY)
      set(LINK_INTERFACE_LIBRARIES LINK_INTERFACE_LIBRARIES)
      set(TARGET_IS_LIBRARY TARGET_IS_LIBRARY)
    endif(ADD_UG_TARGET_IS_LIBRARY)
	...
	#if(NOT ADD_UG_TARGET_IS_LIBRARY)
        foreach(_target ${ADD_UG_UNPARSED_ARGUMENTS})
          target_link_libraries(${_target} ${LINK_INTERFACE_LIBRARIES} ${UG_LIBRARIES} ${DUNE_LIBS})
        endforeach(_target ${ADD_UG_UNPARSED_ARGUMENTS})
	#endif(NOT ADD_UG_TARGET_IS_LIBRARY)
      endif(ADD_UG_OBJECT)
      include_directories(${UG_INCLUDES})
    endif()
    ...
    if(UG_PARALLEL STREQUAL "yes")
      ...
      # Add mpi flags.
      add_dune_mpi_flags(${ADD_UG_UNPARSED_ARGUMENTS} ${TARGET_IS_LIBRARY} ${_source_only})
