...
** Don't obtain father, inside, or outside entity pointers concurrently
...
** Entity iterators and pointers may be concurrently copied
   ...
   caches in the source object, and thus may happen concurrently with other
...
** Keep operations on an entity object in the same thread
   ...
   Concurrent operations on the same entity are possible, but may be
   complicated.
* 
