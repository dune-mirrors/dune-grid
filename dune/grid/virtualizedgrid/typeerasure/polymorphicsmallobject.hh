...
#ifndef DUNE_GRID_VIRTUALIZEDGRID_TYPEERASURE_POLYMORPHICSMALLOBJECT_HH
#define DUNE_GRID_VIRTUALIZEDGRID_TYPEERASURE_POLYMORPHICSMALLOBJECT_HH
 ...
 */
template<class Base, std::size_t bufferSize>
...
public:
  ...
  template<class Derived,
    std::enable_if_t<std::is_base_of_v<Base, remove_cvref_t<Derived>>, int> = 0>
...
#endif // DUNE_GRID_VIRTUALIZEDGRID_TYPEERASURE_POLYMORPHICSMALLOBJECT_HH
